  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
            ...
            return popularProducts.isLoaded
                ...
                : SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: 2,
                      itemBuilder: (_, _) => const PopularProductSkeleton(),
                    ),
                  );
          },
        ),
        ...
        GetBuilder<PopularProductController>(
          builder: (popularProducts) {
            int dotsCount = popularProducts.popularProductList.isEmpty
                ? 1
            ...
            return recommendedProducts.isLoaded
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      int time =
                          int.tryParse(product.timePreparation ?? "32") ?? 32;
                      String speedText;
                      Color speedColor;
                      if (time >= 10 && time <= 20) {
                        speedText = "Rápido";
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              IconAndTextWidget(
                                                ...
                                                text:
                                                    "${product.timePreparation ?? "32"} min",
